...
import { AnimeCreateData, AnimeGenreCreateData, GenderCreateData, GenreCreateData, SeasonCreateData, StatusCreateData, YearCreateData } from "../src/interfaces/createDataInterface.js";
...
async function main() {
  ...
  const years: YearCreateData[] = [
    ...
    { year: 1995 }, { year: 1994 }, { year: 1993 },
    { year: 1992 }, { year: 1991 }, { year: 1990 },
    { year: 1989 }, { year: 1988 }, { year: 1987 },
    { year: 1986 }, { year: 1985 }, { year: 1984 },
    { year: 1983 }, { year: 1982 }, { year: 1981 },
    { year: 1980 }
  ];
  ...
  const animes: AnimeCreateData[] =
    [
      ...
      },
      {
        ...
        image: 'https://media.kitsu.io/anime/45884/poster_image/44328a515399388c211305d5a87806a2.png',
        episodes: 13,
        duration: 23,
      ...
      },
      {
        ...
        image: 'https://media.kitsu.io/anime/45925/poster_image/9457f76efb24610789472f646a25fb6a.png',
        episodes: 13,
        duration: 23,
