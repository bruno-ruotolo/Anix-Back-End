...
import getAnimesSearchService from "../service/searchService.js";
...
export async function getAnimesSearchController(req: Request, res: Response) {
  ...
  const animeList = await getAnimesSearchService.getAnimesSearch(
    genreSearch,
    yearSearch,
    inputSearch
  );
...
export async function getAllYearsController(req: Request, res: Response) {
  const yearsList = await getAnimesSearchService.getAllYearsService();
